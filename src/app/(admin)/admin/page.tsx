...
export default function AdminPage() {
  ...
  const filteredServices = services.filter(
    (s) =>
      ...
      s.category?.some((c) => c.toLowerCase().includes(searchQuery.toLowerCase())) ||
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-[#1a5276]/60">{services.length} total records</p>
        </div>
      ...
      {/* Table */}
      <ServicesTable services={filteredServices} isLoading={isLoading} onRowClick={handleRowClick} />
